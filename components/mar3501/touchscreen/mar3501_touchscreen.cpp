...
static const char *const TAG = "mar3501.touchscreen";
...
void Mar3501Touchscreen::setup() {
  ESP_LOGCONFIG(TAG, "Setting up MAR3501 Touchscreen...");
...
void Mar3501::dump_config() {
  ESP_LOGCONFIG(TAG, "MAR3501 Touchscreen:");
  LOG_I2C_DEVICE(this);
